...
namespace Google {
  ...
  static GoogleSignIn() {
    ...
    private static readonly GoogleSignInConfiguration configuration = new GoogleSignInConfiguration {
      WebClientId = "825756151038-nmmg915h2euugdnjnmi4n5f1k4a2l03u.apps.googleusercontent.com",
      RequestIdToken = true
    };
                              
      
  //   public async UniTask<GoogleSignInUser> OnSignIn() {
  //     GoogleSignIn.Configuration = configuration;
  //     GoogleSignIn.Configuration.UseGameSignIn = false;
  //     GoogleSignIn.Configuration.RequestIdToken = true;
  //     var result = await GoogleSignIn.DefaultInstance.SignIn().AsUniTask();
  //     return result;
  //  }
